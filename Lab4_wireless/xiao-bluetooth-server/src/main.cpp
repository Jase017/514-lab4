...
const int trigPin = D1; // Trig pin connected to D3
const int echoPin = D0; // Echo pin connected to D2
...
#define SERVICE_UUID        "90915b90-f8e9-45c1-a3eb-eba254edced9"
#define CHARACTERISTIC_UUID "de94a198-f148-449f-ba18-d7bb2c6ccf91"
